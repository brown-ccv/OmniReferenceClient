...
const Recording: React.FC<RecordingProp> = ({ isRecording, setRecording, recordingTime, setRecordingTime }) => {
  ...
  let recordingDisabled = state.left.connectionState!==ConnectionState.ConnectedDevice && state.right.connectionState!==ConnectionState.ConnectedDevice
  let warningText = null
  if (recordingDisabled)
    warningText = 'Warning: At least one INS needs to be connected before you can start recording.'
  else if (state.left.connectionState!==ConnectionState.ConnectedDevice)
    warningText = 'Warning: Only your right INS is connected. If you were instructed to record with only one INS, you may proceed.'
  else if (state.right.connectionState!==ConnectionState.ConnectedDevice)
    warningText = 'Warning: Only your left INS is connected. If you were instructed to record with only one INS, you may proceed.'
