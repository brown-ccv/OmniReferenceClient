    ...
    <>
      ...
      <div className='columns'>
        ...
        <div className='column is-half'>
          {/* Boxes for tasks */}
          <TaskBox disabled={disabled} name='Beads' logo={BeadsLogo} onClick={() => launchTask('task-msit')} />
          <TaskBox disabled={disabled} name='CBT' logo={CbtLogo} onClick={() => launchTask('task-msit')} />
          {showProvocationTask
            ? <TaskBox disabled={disabled} name='Provocation' logo={ProvocationLogo} onClick={() => launchTask('task-msit')} />
            : ''}
        ...
        <div className='column is-half'>
          ...
          <TaskBox disabled={disabled} name='Resting' logo={RestingLogo} onClick={() => launchTask('task-msit')} />
        </div>
